        ...
        HStack{
            HStack{
                Button(action: {
                    ...
                    Image("back").renderingMode(.template).resizable().frame(width: 25, height: 25).aspectRatio(contentMode: .fit).foregroundColor(.white).padding(EdgeInsets(top: 0, leading: 15, bottom: 0, trailing: 0))
                }
                ...
                Menu {
                    ...
                    Button(action: {}){
                        Image("more")
                            ...
                            .aspectRatio(contentMode: .fit).foregroundColor(.white).padding(EdgeInsets(top: 0, leading: 0, bottom: 0, trailing: 15))
                        }
                    .padding(.top, 5)
                }
            }.padding()
                    ...
                    HStack{
                        if search_index == 2 {
                            DatePicker("", selection: $startDate, displayedComponents: .date)
                                ...
                                .cornerRadius(4)
                                .padding(EdgeInsets(top: 0, leading: 15, bottom: 0, trailing: 3))
                            Spacer()
...
//                            SearchTextFieldWidget(search_txt: $search_txt, search_index: $search_index, search_place_txt: search_place_txt)
                        }
                    }
                    Button(action:{
                        searchData()
