                                    ...
                                    Button(action: {
                                        ...
                                        : Alert(
                                            ...
                                            primaryButton: .destructive(Text("End Now")) {
                                                ...
                                                print("jo chahye \(helper.getDate(st: Date()))")
                                                print("ctc\(data.currentPeriod)")

                                                data.isEnd = true
                                                data.currentPeriod.cancel_date = helper.getDate(st: Date())
                                                data.histories.append(data.currentPeriod)
                                                data.currentPeriod = PeriodModel(start_date: data.currentPeriod.start_date, end_date: "", cancel_date : "",  order_list: [])
                                                pageIndex = 11
                                                helper.setVariable(data: data)
